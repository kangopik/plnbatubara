...
<div class="row">
    <div class="col-lg-12">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h4>&nbsp;</h4>
                    <form action="{{action('DetailController@savedetailkeuanganedit')}}" method="post">
                    <input type="hidden" name="_token" value="<?= csrf_token(); ?>">
                    <table class="table table-bordered">
                        <tbody>
                            <tr>
                                <td style="border-top:none;" colspan="2"><b>Enable Edit</b></td>
                                <td width="30" style="text-align:left;">
                                    <input type="checkbox" name="enedit" value="0" <?php if($datahasil->Status=='0') { echo "checked='checked'";}?>/>
                                </td>
                        ...
                        <tr>
                            <td width=100%>
                                    <button  type="submit" style="text-transform:none; width:150px;"
                                        class="btn btn-submit  btn-primary">Simpan</button>
                            </td>  
                        <tr>
                    </table>
                            <p>&nbsp;</p>
