			...
			<div class="col-md-12 clearfix">
				<div id="tab_content_data">
        			<ul class="nav nav-tabs" data-toggle="tabs">
                        ...
                        <li class="active">
                            <a href="javascript:void(0);" >KONTRAK</a>
                        </li>
                        <?php } ?>
                    </ul>
                            ...
                            <tr>
                                ...
                                <td style="text-align:center;">
                                    <a href="" onclick="document.getElementById('lokasi').value='<?php echo $row->LokasiPasokan ?>';
                                                        ...
                                                        <?php } ?>
                                                        <?php if(($row->PrestasiCk=='1') || ($datavendor->PersetujuanVerifikasi=='Y')) { ?>
                                                        document.getElementById('PrestasiCk').checked = true;
                                                        <?php } else { ?>                                                                                
                                                        document.getElementById('PrestasiCk').checked = false;
                                                        <?php } ?>"
                ...
                <table width=100%>
                                        <tr>
                                            <td width=50%>
                                                <a href="<?php echo 'DetailPengalaman' ?>" class="btn btn-primary btn-block btn-flat" 
                                            ...
                                            <td width=50%>
                                                    <a href="<?php echo 'verifikasi' ?>"  type="submit" style="text-transform:none; width:150px;"
                ...
                <div class="modal-dialog vertical-align-center" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="{{action('DetailController@savedetailkontrak')}}" method="post">
                                <input type="hidden" name="_token" value="<?= csrf_token(); ?>">
                                <table class="table table-bordered" style="border:none;">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td width="30" style="text-align:left; border:none;">
                                                <input type="checkbox" name="PrestasiCk" id="PrestasiCk" value="1"/>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
