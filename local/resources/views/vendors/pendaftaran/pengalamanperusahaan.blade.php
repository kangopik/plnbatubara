...
<div class="row">
	<div class="col-lg-12">
		<h2 class="page-header">Pengalaman Calon Penyedia Batubara <?php echo $data4->Nama.', '.$data4->BadanUsaha; ?></h2>
      			...
      			<div class="modal-dialog vertical-align-center" role="document">
        			<div class="modal-content">
          				...
          				<div class="modal-body">
            				<form action="{{action('VendorController@savepengalamanperusahaan')}}" method="post">
            							...
            							<tr>
            								...
            								<td style="border:none;"><a style="font-size:16px;">MT</a>
            									<div class="col-sm-5" style="padding-right: 5px;">
                                                    <div data-tip="masukan volume pasokan">
        ...
        <!-- modal confirm delete pengalaman -->
        <div class="modal fade" id="confirmPengalamanModal" tabindex="-1" role="dialog">
            <div class="vertical-alignment-helper">
                <div class="modal-dialog vertical-align-center">
                    <div class="modal-content">
                        <form action="{{action('VendorController@deletekontrakpengadaan')}}" method="post">
                            <input type="hidden" name="_token" value="<?= csrf_token(); ?>">
                            <div class="modal-body">
                                <h4>Anda yakin akan menghapus data Pengalaman <input style="border:none;" type="text" 
		...
		<div class="row">
                            ...
                            <tr>
                                ...
                                <td style="text-align:center;">
                                    ...
                                    <a href="" onclick="document.getElementById('lokasi').value='<?php echo $row->LokasiPasokan ?>';
                                                        ...
                                                        document.getElementById('tgl_pengalaman').setAttribute('readOnly','true');
                                                        document.getElementById('tgl_pengalaman').style.background = '#eee'; 
                                                        document.getElementById('tgl_pengalaman').style.color = '#555';
                                                        <?php } else if($row->TanggalCk=='0') { ?>
                                                        document.getElementById('tgl_pengalaman').style.background = 'red';
                                                        document.getElementById('tgl_pengalaman').style.color = '#FFF';
                                                        <?php } else { ?>
                                                        document.getElementById('tgl_pengalaman').style.background = '#FFF';
                                                        document.getElementById('tgl_pengalaman').style.color = '#555';
                                                        <?php } ?>
                                                        ...
                                                        document.getElementById('waktu').style.color = '#555';
                                                        <?php } ?>
                                                        <?php if(($row->NilaiCk=='1') || ($row->PersetujuanVerifikasi=='Y' && $dataHasil->Status==1)) { ?>
                                                        ...
                                                        document.getElementById('nilai').style.color = '#555';
                                                        <?php } ?>
                                                        <?php if(($row->BACk=='1') || ($row->PersetujuanVerifikasi=='Y' && $dataHasil->Status==1)) { ?>
                                    ...
                                    <a href="" onclick="document.getElementById('namalokasi').value='<?php echo $row->LokasiPasokan ?>';"
                                            data-toggle="modal" data-target="#confirmPengalamanModal">
                ...
                <?php  if($dataHasil->PersetujuanVerifikasi <> 'Y' ^ $dataHasil->Status<>1 || $dataHasil->StatusPakta <> 'Y') { ?>
				<input type="button" value="Tambah Pengalaman" class="btn btn-submit btn-primary" 
						data-toggle="modal" data-target="#pengalamanModal"
                        onclick="document.getElementById('lokasi').value='';
                                ...
                                $('#nomor').attr('readonly', false);
                                document.getElementById('tgl_pengalaman').value='';
                                document.getElementById('tgl_pengalaman').style.background = '#FFF';
                                document.getElementById('tgl_pengalaman').style.color = '#555';
        ...
        <table align=center>
            <tr align=center>
                <td align=center>
                    ...
                    <a href="<?php echo 'kontrakpengadaanbatubara' ?>" class="btn btn-submit btn-primary" id="btnnext">Berikutnya
