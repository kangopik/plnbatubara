...
<div class="row">
    <div class="col-lg-12">
        <h2 class="page-header">Entry Data Negosiasi</h2>

        <table>
            <form action="{{action('AdminController@carivendorentrynegosiasi')}}" method="post">
                ...
                <tr>
                    ...
                    <td width=100 style="padding-left:10px;">
                        <input type="button" class="btn btn-primary btn-block btn-flat" 
                                onclick="location.href='<?php echo 'entrydatanegosiasi' ?>';" value="Reset" />
                    </td>
                    <td width=100>&nbsp;</td>
                </tr>
                <tr><td>&nbsp;</td></tr>
          ...
          <tbody>
            ...
            <tr class="tr-pengumuman">
                ...
                <td style="text-align:center;"> 
                    <a href="<?php echo 'EvalNegosiasi/'.$row->UserId ?>">
