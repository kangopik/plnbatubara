...
<div class="row">
    <div class="col-lg-12">
        <h2 class="page-header">Undangan CDA</h2>

        <table>
            <form action="{{action('AdminController@carivendorundangancda')}}" method="post">
                ...
                <tr>
                    ...
                    <td width=100 style="padding-left:10px;">
                        <input type="button" class="btn btn-primary btn-block btn-flat" 
                                onclick="location.href='<?php echo 'undangcda' ?>';" value="Reset" />
                    </td>
                    <td width=100>&nbsp;</td>
                </tr>
                <tr><td>&nbsp;</td></tr>
        ...
        <!-- modal --> 
        <div class="modal fade" id="cdaModal" tabindex="-1" role="dialog" aria-labelledby="cdaModalLabel">
            <div class="vertical-alignment-helper">
            <div class="modal-dialog vertical-align-center" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title" id="cdaModalLabel">Undangan CDA</h4>
                    </div>
                    <div class="modal-body">
                        <form action="{{action('AdminController@aksiundangcda')}}" method="post">
                            <input type="hidden" name="_token" value="<?= csrf_token(); ?>">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="border:none;">
                                            <div class="col-sm-6">
                                                <div data-tip="masukan hari undangan cda">
                                    ...
                                    <tr>
                                        ...
                                        <td style="border:none;">
                                            <div class="col-sm-5">
                                                <div data-tip="masukan tanggal undangan cda">
                                                <input type="text" class="form-control" name="tgl_undangan_cda" 
                                    ...
                                    <tr>
                                        ...
                                        <td style="border:none;">
                                            <div class="col-sm-5">
                                                <div data-tip="masukan jam undangan cda">
                                    ...
                                    <tr>
                                        ...
                                        <td style="border:none;">
                                            <div class="col-sm-12">
                                                <div data-tip="masukan tempat undangan cda">
                                    ...
                                    <tr>
                                        ...
                                        <td style="border:none;">
                                            <div class="col-sm-12">
                                                <div data-tip="masukan acara undangan cda">
                                    ...
                                    <tr>
                                        ...
                                        <td style="border:none;">
                                        <div class="col-sm-12">
                                            <div data-tip="masukan nama contact person undangan cda">
            ...
            <tr class="tr-pengumuman">
              ...
              <td>
                <a href="" onclick="document.getElementById('vendorid').value='<?php echo $row->UserId ?>';
                    ...
                    data-toggle="modal" data-target="#cdaModal"><i class="fa fa-envelope"></i> UNDANG VENDOR</a>
              </td>
            </tr>
            <?php 
                $counter++;
